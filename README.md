...
**Solana Raydium Sniper Bot** that listens to new Raydium SOL pools and buys tokens for a fixed amount in USDC/SOL.
...
3. Convert some SOL to WSOL (you need WSOL depending on the configuration set below)
